...
long long int ignbin(long long int n,double pp, MTRand *ranmar)
/*
**********************************************************************
...
static long long int nsave = -1;
static long long int ignbin,i,ix,ix1,k,m,mp,T1;
...
S20:
    ...
    fm = m;
    xnpq = xnp*q;
    p1 = (long long int) (2.195*sqrt(xnpq)-4.6*q)+0.5;
    xm = fm+0.5;
    xl = xm-p1;
    xr = xm+p1;
...
*/
    qn = (long double)pow((long double)(q),(long double)(n));
    r = p/q;
    g = r*(n+1);
S150:
    ix = 0;
